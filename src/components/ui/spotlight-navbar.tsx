...
export interface SpotlightNavbarProps {
    ...
    /**
     * Index actif imposé de l'extérieur. Quand il est fourni, la barre suit
     * cette valeur au lieu de son état interne : c'est ce qui permet au halo
     * de suivre le défilement et pas seulement les clics.
     */
    activeIndex?: number;
}
        ...
        */}
            ...
            `,
                ...
                <div
                    ...
                    style={{
                        // `--ambience-x` garde sa dernière valeur quand plus aucun
                        // onglet n'est actif : sans ce voile, la lumière restait
                        // allumée sous « À propos » une fois revenu dans le hero.
